          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: kTextFiledColor.withOpacity(0.25), blurRadius: 4)
                  ],
                  borderRadius: BorderRadius.circular(4)),
              child: BlocBuilder<IssueProductionOrdersCubit,
                  IssueProductionOrdersState>(builder: (context, state) {
                return Column(
                  children: [
                    Container(
                        width: context.width,
                          ...
                          addNewOnPressed: () {
                            context.activeTabsCubit.addActiveTab(
                              ScreensEnt(
                                ...
                                screenName:
                                    'issue_production_orders'.tr(context),
                                tabName: 'all_issue_production_orders'.tr(context),
                                screenPath:
                                    'AppPaths.newIssueProductionOrdersScreen',
                                ...
                                screenId: 11533,
                                sysNo: 73,
                                builder: (context, cubit) => BlocProvider<
                                    IssueProductionOrdersCubit>.value(
