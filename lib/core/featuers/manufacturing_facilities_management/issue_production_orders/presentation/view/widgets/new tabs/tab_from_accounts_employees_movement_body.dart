...
class TabFromAccountsEmployeesMovementBody extends StatelessWidget {
  const TabFromAccountsEmployeesMovementBody({super.key});
      ...
      return Column(children: [
        SizedBox(
            ...
            child: OnyxIxGrid(
              ...
              rows: expenseList
    .map((e) => OnyxIxRow(cells: {
          'document_name': OnyxIxCell(value: e['document_name']),
          'document_date': OnyxIxCell(value: e['document_date']),
          'reference_number': OnyxIxCell(value: e['reference_number']),
          'document_type': OnyxIxCell(value: e['document_type']),
          'type_of_reference_document': OnyxIxCell(value: e['type_of_reference_document']),
          ...
          'duration_in_days': OnyxIxCell(value: e['duration_in_days']),
          'from_time': OnyxIxCell(value: e['from_time']),
          'to_time': OnyxIxCell(value: e['to_time']),
          'duration_in_hours': OnyxIxCell(value: e['duration_in_hours']),
