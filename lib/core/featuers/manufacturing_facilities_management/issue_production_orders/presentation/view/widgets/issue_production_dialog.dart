                    ...
                    child: OnyxIxGrid(
                      ...
                      rows: expenseList
                          ...
                          .map((e) => OnyxIxRow(cells: {
                                ...
                                'input_id':
                                    OnyxIxCell(value: e.value['input_id']),
                                'connect_means_type': OnyxIxCell(
                                    value: e.value['connect_means_type']),
                                'contact_type':
                                    OnyxIxCell(value: e.value['contact_type']),
                                ...
                                'default':
                                    OnyxIxCell(value: e.value['default']),
