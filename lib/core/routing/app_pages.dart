...
// Create the TreeNotifier instance
final ValueNotifier<Map<String, ScreensEnt>?> treeNotifier =
ValueNotifier<Map<String, ScreensEnt>?>(
    getIt<AppLayoutCubit>().state.featuresMap);
  ...
  return GoRouter(
      ...
      routes: <RouteBase>[
        ...
        ShellRoute(
          ...
          observers: [
            MyNavigatorObserver(shellNavigatorKey),
          ],
