...
class MaterialOrderReleaseUseCase {
  ...
  MaterialOrderReleaseUseCase(this.materialOrderReleaseCont);

  Future<Either<Failure, MaterialOrderReleaseEnt>> call({required String s}) async {
    return await materialOrderReleaseCont.func(s: s);
  }
}