      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: BlocBuilder<MaterialOrderReleaseCubit, MaterialOrderReleaseState>(
                      ...
                      child: FiltersHeaderPreviousSales(
                        addNewOnPressed: () {
                          context.activeTabsCubit.addActiveTab(
                            ScreensEnt(
                              tabPath: AppPaths.newmaterialOrderReleaseScreen,
                        ...
                        rowsOnyxIx: context
                            .read<MaterialOrderReleaseCubit>()
                            .rowsOnyxIx,
                        rowData: context.read<MaterialOrderReleaseCubit>().rowData,
