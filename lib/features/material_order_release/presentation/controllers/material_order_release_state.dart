part of 'material_order_release_cubit.dart';
...
@immutable
class MaterialOrderReleaseState {
  ...
  const MaterialOrderReleaseState({
  ...
  MaterialOrderReleaseState copyWith({
    bool? isLoading,
    String? errMsg,
    ...
    return MaterialOrderReleaseState(
