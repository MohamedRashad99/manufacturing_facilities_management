<<<<<<< HEAD:lib/core/featuers/manufacturing_facilities_management/issue_production_orders/presentation/controllers/issue_production_orders_cubit.dart
...
>>>>>>> eda929e3db34cacbddbce67677778f2ebac1d2f9:lib/features/issue_production_orders/presentation/controllers/issue_production_orders_cubit.dart
class IssueProductionOrdersCubit extends Cubit<IssueProductionOrdersState> {
  ...
  final List<Map<String, dynamic>> rowData = [
    {
      ...
      'seller_invoice_number':
          'seller_invoice_number'.tr(navigatorKey.currentContext!),
      'vendor_invoice_date':
          'vendor_invoice_date'.tr(navigatorKey.currentContext!),
      'bill_lading_number':
          'bill_lading_number'.tr(navigatorKey.currentContext!),
  ...
  List<OnyxIxColumn> columnsOnyxIx = <OnyxIxColumn>[
    ...
    OnyxIxColumn(
      title:
          'warehouse_name'.tr(navigatorKey.currentContext!), // Warehouse Name
    ...
    OnyxIxColumn(
      title:
          'financial_unit'.tr(navigatorKey.currentContext!), // Financial Unit
