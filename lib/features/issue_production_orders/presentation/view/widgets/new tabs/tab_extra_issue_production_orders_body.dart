...
class TabExtraIssueProductionOrdersBody extends StatelessWidget {
  const TabExtraIssueProductionOrdersBody({super.key});
  @override
        ...
        SizedBox(
          ...
          child: FlexibleWrapWidget(
            ...
            itemWidth: context.getWidth(
                ratioDesktop: 0.13, ratioMobile: 0.9, ratioTablet: 0.3),
            children: [
